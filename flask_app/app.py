...
df = pd.read_csv("/Users/kashishdatta/FraudDetection/flask_app/model/fraud_data_final.csv")

with open('/Users/kashishdatta/FraudDetection/flask_app/model/fraud_model_final.bin', 'rb') as f_in:
